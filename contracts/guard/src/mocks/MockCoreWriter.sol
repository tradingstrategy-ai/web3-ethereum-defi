...
contract MockCoreWriter {
    ...
    function sendRawAction(bytes calldata data) external {
        ...
        actions.push(RecordedAction({sender: msg.sender, version: version, actionId: actionId, params: params}));
    ...
    function getAction(uint256 index)
        external
        view
        returns (address sender, uint8 version, uint24 actionId, bytes memory params)
    {
