...
contract MockCoreDepositWallet {
    ...
    function deposit(uint256 amount, uint32 destinationDex) external {
        deposits.push(RecordedDeposit({sender: msg.sender, amount: amount, destinationDex: destinationDex}));
    ...
    function getDeposit(uint256 index) external view returns (address sender, uint256 amount, uint32 destinationDex) {
