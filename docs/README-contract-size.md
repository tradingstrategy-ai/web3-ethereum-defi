...
| LagoonLib | guard | 5,125 | 20.9% | 19,451 |
...
| `LagoonLib` | Lagoon allowlisting, atomic cumulative gross-settlement-window validation | 5,125 | `keccak256("eth_defi.lagoon.v1")` |
