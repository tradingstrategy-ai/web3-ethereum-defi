...
deposit or withdrawal fees, and waiting time are not deducted. GMX has no
depositor-facing management or performance fee, so the generic vault fee
interface reports those two fee types as zero.
