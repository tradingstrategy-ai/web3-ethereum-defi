...
- feat: Add canonical per-period vault deposit and redemption values and counts, estimate netted stablecoin ERC-4626 flows from daily vault states, and deprecate the legacy top-level netflow export (2026-08-31)
