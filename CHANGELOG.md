...
- feat: Add a standalone ApeX Omni all-vault reader with bounded public API access, flexible timestamp observations, historical backfills and DuckDB storage (2026-07-23)
