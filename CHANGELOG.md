...
- feat: Add ERC-4626 share price staleness diagnostics via reader-state metadata, exposing last checked/changed timestamps, latest check errors, poll frequency, and applicability in vault metrics without emitting heartbeat price rows or changing price Parquet schema (2026-04-24)
