...
- feat: Add complete short and long offchain listing descriptions for every Enzyme Blue and Onyx vault, with neutral per-architecture fallback copy when a manager has not published strategy details (2026-08-21)
