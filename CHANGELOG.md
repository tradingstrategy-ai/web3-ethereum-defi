...
- feat: Surface ApeX Omni on the vaults site with protocol metadata and logo, a rollout-period TVL export threshold for ApeX copy-trading vaults, and curated descriptions plus captured onchain addresses for the ApeX official Protocol Vaults (2026-07-25)
