...
- Add: Ember vault offchain metadata expanded with all official API fields (long name, status, tags, depositor counts, APY breakdown, rewards, supported coins) and risk level lowered to low (2026-03-16)
