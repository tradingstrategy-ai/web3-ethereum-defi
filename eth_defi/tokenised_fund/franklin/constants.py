...
IBENJI_ETHEREUM = FranklinProduct(
    ...
    short_description="Tokenised institutional liquidity fund for eligible investors",
    description="Franklin OnChain Institutional Liquidity Fund Ltd. is a permissioned professional fund managed by Franklin Advisers for eligible institutional investors. Its iBENJI token records fund-share ownership on Ethereum and publishes an issuer-maintained USD reference price, while subscriptions and redemptions remain subject to the Benji transfer-agent process.",
...
BENJI_ETHEREUM = FranklinProduct(
    ...
    short_description="Tokenised U.S. government money-market fund",
    description="The Franklin OnChain U.S. Government Money Fund seeks current income while preserving shareholder capital and liquidity. It invests at least 99.5% of its assets in U.S. government securities, cash and repurchase agreements fully collateralised by government securities or cash, and seeks to maintain a stable one-dollar share price.",
