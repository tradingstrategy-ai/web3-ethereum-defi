...
#: Explicit discovery lead for the requested FILQ-A deployment. FILQ-D is not
#: included until its deployment block is independently recorded.
SYGNUM_HARDCODED_LEADS = ((SYGNUM_ETHEREUM_CHAIN_ID, FILQ_A_ETHEREUM_ADDRESS, FILQ_A_ETHEREUM_FIRST_SEEN_AT_BLOCK, FILQ_A_ETHEREUM_FIRST_SEEN_AT),)
