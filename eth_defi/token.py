...
STABLECOIN_METADATA: dict[str, list[StablecoinInfo]] = {
    ...
    "NUSD": [{"name": "Neutrl NUSD", "homepage": "https://www.neutrl.com/", "description": "NUSD is a delta-neutral stablecoin by Neutrl that maintains its peg through hedged positions. It is designed for DeFi stability through market-neutral strategies. NUSD is available on Ethereum.", "coingecko": "", "defillama": "", "twitter": "https://x.com/neutaborrl"}],
    ...
    "rUSD": [{"name": "IPOR rUSD", "homepage": "https://ipor.io/", "description": "rUSD is a stablecoin from the IPOR protocol ecosystem. It is designed for yield optimisation in DeFi interest rate markets. rUSD is part of IPOR's suite of interest rate derivatives and lending products.", "coingecko": "", "defillama": "", "twitter": "https://x.com/ipaboror_io"}],
    ...
    "USD₮0": [{"name": "Tether USD₮0", "homepage": "https://tether.to/", "description": "USD₮0 is a variant of Tether's USDT stablecoin with a Unicode symbol representation. It is functionally equivalent to USDT and backed by Tether's reserves. The symbol variant appears on certain chains and exchanges.", "coingecko": "", "defillama": "", "twitter": "https://x.com/Tether_to"}],
    ...
    "USG": [{"name": "Tangent USD", "homepage": "https://www.tangent.finance/", "description": "USG is a decentralised over-collateralised USD stablecoin by Tangent Finance, backed by productive LPs and yield-bearing assets from Curve, Convex, and Pendle. Users can borrow with zero interest in dedicated High Emissions Collateral markets. A dynamic interest rate model activates only when USG trades below its price threshold.", "coingecko": "", "defillama": "", "twitter": "https://x.com/Tangent_fi"}],
    "USX": [{"name": "dForce USD", "homepage": "https://dforce.network/", "description": "USX is a decentralised stablecoin issued by dForce on Ethereum and other chains. It is overcollateralised by various crypto assets through the dForce lending protocol. USX is designed for multi-chain DeFi activities.", "coingecko": "https://www.coingecko.com/en/coins/dforce-usd", "defillama": "https://defillama.com/stablecoin/dforce-usd", "twitter": "https://x.com/dForcenet"}],
    ...
    "sUSG": [{"name": "Staked Tangent USD", "homepage": "https://www.tangent.finance/", "description": "sUSG is the yield-bearing savings version of Tangent Finance's USG stablecoin, built on the Yearn v3 vault standard. It auto-compounds protocol revenues — 25% of Tangent's revenue is distributed as sUSG yield. Minting and redemption for USG occur without fees or delays.", "coingecko": "", "defillama": "", "twitter": "https://x.com/Tangent_fi"}],
