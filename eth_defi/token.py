...
#: USDf and USDF
STABLECOIN_LIKE = set(
    ["ALUSD", "AUSD", "BAC", "BDO", "BEAN", "BOB", "BUSD", "CADC", "CEUR", "CJPY", "CNHT", "CRVUSD", "CUSD", "DAI", "DJED", "DOLA", "DUSD", "EOSDT", "EURA", "EUROC", "EUROe", "EURS", "EURT", "EURe", "EUSD", "FDUSD", "FEI", "FLEXUSD", "FRAX", "FXD", "FXUSD", "GBPT", "GHO", "GHST", "GUSD", "GYD", "GYEN", "HUSD", "IRON", "JCHF", "JPYC", "KDAI", "LISUSD", "LUSD", "MIM", "MIMATIC", "MKUSD", "MUSD", "ONC", "OUSD", "PAR", "PAXG", "PYUSD", "RAI", "RLUSD", "RUSD", "SDAI", "SEUR", "SFRAX", "SILK", "STUSD", "SUSD", "TCNH", "TOR", "TRYB", "TUSD", "USC", "USD+", "USD0", "USD1", "USDA", "USDB", "USDC", "USDC.e", "USDD", "USDE", "USDF", "USDM", "USDN", "USDO", "USDP", "USDR", "USDS", "USDT", "USDT.e", "USDV", "USDX", "USDXL", "USDe", "USDf", "USDs", "USDt", "USK", "USR", "UST", "USTC", "USX", "UUSD", "VAI", "VEUR", "VST", "VUSD", "WXDAI", "XAUT", "XDAI", "XIDR", "XSGD", "XSTUSD", "XUSD", "YUSD", "ZSD", "ZUSD", "avUSD", "crvUSD", "deUSD", "gmUSD", "iUSD", "jEUR", "kUSD", "lvlUSD", "sosUSDT", "wM", "satUSD"]
)
