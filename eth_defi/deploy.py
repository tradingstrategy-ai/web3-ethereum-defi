...
GUARD_FORGE_LIBRARY_SOURCES: dict[str, str] = {
    ...
    "LagoonLib": "src/lib/LagoonLib.sol:LagoonLib",
    "LighterLib": "src/lib/LighterLib.sol:LighterLib",
...
SAFE_INTEGRATION_FORGE_LIBRARY_SOURCES: dict[str, str] = {
    ...
    "LagoonLib": "../guard/src/lib/LagoonLib.sol:LagoonLib",
    "LighterLib": "../guard/src/lib/LighterLib.sol:LighterLib",
