...
def test_get_recent_prices_success(chain_name):
    ...
    try:
        ...
        for token_addr, token_data in prices.items():
            if (token_data.get("minPrice") is not None and 
                token_data.get("maxPrice") is not None and
                isinstance(token_data.get("minPrice"), str) and
                isinstance(token_data.get("maxPrice"), str)):
        ...
        "signedPrices": [
            {
                ...
                "minPrice": "2500000000000000000000",
                "maxPrice": "2550000000000000000000", 
                "createdAt": "2025-08-24T18:21:38.680Z"
            },
            {
                "tokenAddress": "0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f",
                "minPrice": "45000000000000000000000",
                "maxPrice": "45500000000000000000000",
                "createdAt": "2025-08-24T18:21:38.680Z"
            }
        ]
    }
...
def test_full_integration_flow(chain_name):
    ...
    try:
        ...
        for token_address, price_data in prices.items():
            ...
            if (price_data.get("minPrice") is not None and 
                price_data.get("maxPrice") is not None):
                try:
