"""
    export POLYGON_CHAIN_JSON_RPC="https://rpc.ankr.com/polygon"
...
pytestmark = pytest.mark.skipif(
    (os.environ.get("POLYGON_CHAIN_JSON_RPC") is None) or (shutil.which("anvil") is None),
    reason="Set POLYGON_CHAIN_JSON_RPC env in order to run these tests",
)
