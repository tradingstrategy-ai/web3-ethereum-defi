...
EXISTING_ETHEREUM_CURSOR = 22_000_000
OTHER_CHAIN_ID = 8453
...
def test_franklin_metadata_upsert_preserves_discovery_cursor(backfill_history_module: ModuleType, existing_cursor: int | None) -> None:
    ...
    backfill_history_module.upsert_franklin_metadata_preserving_discovery_cursor(vault_db, leads, rows)
