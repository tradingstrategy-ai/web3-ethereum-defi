...
.. code-block:: shell
    ...
    # Skip Derive v3 mainnet native vaults
    SCAN_DERIVE_V3=false python scripts/erc-4626/scan-vaults-all-chains.py
...
Environment variables:
    ...
    - SCAN_DERIVE_V3: "false" to skip Derive v3 mainnet native vaults (default: "true")
